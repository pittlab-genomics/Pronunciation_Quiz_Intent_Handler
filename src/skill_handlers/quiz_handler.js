    ...
    async handle(handlerInput) {
        ...
        if (slotValues.user_identifier.heardAs && quiz) {
            ...
            if (quiz === 'GENE_QUIZ') {
                ...
                console.error(`[UserIdentifierIntentHandler] session attribute quiz is invalid: ${JSON.stringify(requestEnvelope)}`);
                return responseBuilder
...
const RepeatQuizIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        if (quiz === 'GENE_QUIZ') {
            ...
            console.error(`[RepeatQuizIntentHandler] session attribute quiz is invalid: ${JSON.stringify(requestEnvelope)}`);
            return responseBuilder
                .speak("Please start a quiz first.")
                .getResponse();
        }
